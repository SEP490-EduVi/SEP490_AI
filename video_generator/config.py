...
# Interaction timing
INTERACTION_CLIP_DURATION_SEC = float(os.getenv("INTERACTION_CLIP_DURATION_SEC", "1.0"))
QUIZ_PAUSE_OFFSET_SEC = float(os.getenv("QUIZ_PAUSE_OFFSET_SEC", "1.0"))
QUIZ_PAUSE_EDGE_GUARD_SEC = float(os.getenv("QUIZ_PAUSE_EDGE_GUARD_SEC", "1.0"))
