...
def run(source: str, subject: str, grade: str, book_id: str) -> dict:
    ...
    try:
        ...
        if os.path.isfile(source):
            ...
            local_path = download_from_gcs(source)
            is_temp = True
        ...
        raw_text = extract_text(local_path, skip_start=skip_start, skip_end=skip_end)
        ...
        # Parse CHAPTER_LIMIT early so we can pass it to the extractor
